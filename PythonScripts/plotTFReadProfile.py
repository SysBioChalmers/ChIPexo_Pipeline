...
plt.plot(TFData.columns,[TFData.mean(axis=0).mean()]*len(TFData.columns),'r--',lineWidth=2,label='Average')
plt.plot(TFData.mean(axis=0),'b',lineWidth=2,label=selectedTF+'_'+selectedCond)
